...
<html lang="en">
  ...
  <body>
    ...
    <main id="features_main">
      ...
      <div class="full-height" id="classrooms">
        <div class="container col-md-offset-4 col-md-8 card-dark card-dark-fade">
          <h2>CLASSROOMS </h2>
          <h4 class="light-text spread-text">General information on what this module does.</h4>
          <br>
          <h3>Teachers</h3>
      ...
      <div class="full-height" id="schedules">
        <div class="col-md-8 card-dark">
          <h2>SCHEDULES </h2>
          <h4 class="light-text spread-text">General description on what this module entails.</h4>
          <br>
